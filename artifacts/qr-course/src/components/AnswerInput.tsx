  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <textarea
        ...
        onPaste={handlePaste}
        onDrop={handleDrop}
        placeholder={placeholder || "Write your answer here in your own words..."}
        disabled={disabled}
        className="w-full min-h-[200px] p-4 bg-card border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-base leading-relaxed resize-y"
      />
      <span className="text-xs text-muted-foreground px-1">
        Write in full sentences, in your own words. Pasting is disabled.
      </span>
    </div>
  );
}
