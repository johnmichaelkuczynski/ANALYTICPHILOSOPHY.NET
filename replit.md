...
- **Unified Knowledge Base**: ALL philosophical texts (Kuczynski, Freud, Jung, James, Veblen, Hegel, Russell, and 40+ other figures) consolidated into single Common Fund with figureId='common'. Contains **27,969 chunks across 185 unique works**. Enables comprehensive cross-philosopher semantic search for knowledge serving to external applications. Previous dual-pool architecture replaced with streamlined single-pool retrieval.
- **Integrated Philosophical and Literary Works**: Extensive works from 44 philosophers and literary figures are integrated. Recent additions include Kuczynski's "Extended Set Theory and Logic with Applications" (485 chunks), "Logic, Set-theory, and Philosophy of Mathematics" (260 chunks), "Propositions: Nature and Structure" (95 chunks), "Dictionary of Analytic Philosophy" (102 chunks), Jung's "Psychology of the Unconscious" (801 chunks), and works on psychopathology, Kant studies, and contemporary philosophy.
