...
- **OpenAI** — provided through the Replit-managed OpenAI AI integration (`@workspace/integrations-openai-ai-server`); no `OPENAI_API_KEY` is hard-coded or requested. Powers the tutor, practice generator, AI graders, and lecture-expansion job.
