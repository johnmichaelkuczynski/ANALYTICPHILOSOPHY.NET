      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-8 py-4">
          ...
          <div className="space-y-3">
            ...
            <Select
              value={localSettings.selectedModel || "zhi1"}
              onValueChange={(value) =>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="zhi1">Zhi 1 - Most sophisticated, nuanced reasoning (default)</SelectItem>
                <SelectItem value="zhi2">Zhi 2 - Fast, versatile, creative</SelectItem>
